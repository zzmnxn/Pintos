...
struct thread
  {
    ...
    int64_t wakeup_tick;                /* Time when thread should wake up. */
    ...
    struct lock *waiting_for_lock;      /* Lock this thread is waiting for. */
    struct list donated_locks;           /* List of locks owned by this thread. */
